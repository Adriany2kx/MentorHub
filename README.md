...
- Profile quality score — suggestions to improve profile for better matches
- Progress insights — highlights, stalled areas, session frequency
- Session summaries — key points, decisions, action items, follow-up questions
- Compatibility score — per-mentor match explanation
- Learning path generation — staged roadmap toward target role
