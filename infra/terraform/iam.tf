...
# ECS Task Role (S3 access for file uploads)
...
# GitHub Actions OIDC (deploy without long-lived credentials)
resource "aws_iam_openid_connect_provider" "github" {
  url             = "https://token.actions.githubusercontent.com"
  client_id_list  = ["sts.amazonaws.com"]
  thumbprint_list = ["ffffffffffffffffffffffffffffffffffffffff"] # GitHub's thumbprint
}
